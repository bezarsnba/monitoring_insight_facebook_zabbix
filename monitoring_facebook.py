#!/usr/bin/python2.7
#Author: Bezaliel Ramos (bramos@onxsolutions.net)
##SCRIPT para monitorar ADs Facebook
import sys
import argparse
import urllib2
import json
# unread_message_count == Mensagem nao lida
...
page_id = "<PAGE ID>" # any username or id
